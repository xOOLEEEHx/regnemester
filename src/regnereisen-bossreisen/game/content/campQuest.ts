...
export const CAMP_SPOKE_ASSET_PATH = '/regnemester/camp/wagon-wheel-spoke.png';
export const CAMP_RIM_TEXTURE_KEY = 'camp-wheel-rim';
export const CAMP_RIM_ASSET_PATH = '/regnemester/camp/wagon-wheel-rim.png';
export const CAMP_HUB_TEXTURE_KEY = 'camp-wheel-hub';
export const CAMP_HUB_ASSET_PATH = '/regnemester/camp/wagon-wheel-hub.png';
