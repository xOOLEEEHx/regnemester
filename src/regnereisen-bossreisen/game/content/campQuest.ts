...
export const CAMP_RESIDENT_WAGON_ASSET_PATH = '/regnemester/camp/camp-resident-broken-wagon.png';
export const CAMP_RESIDENT_ASSET_PATH = '/regnemester/camp/camp-resident.png';
export const CAMP_SPOKE_TEXTURE_KEY = 'camp-wheel-spoke';
export const CAMP_SPOKE_ASSET_PATH = '/regnemester/camp/wagon-wheel-spoke-optimized.png';
export const CAMP_RIM_TEXTURE_KEY = 'camp-wheel-rim';
export const CAMP_RIM_ASSET_PATH = '/regnemester/camp/wagon-wheel-rim-optimized.png';
export const CAMP_HUB_TEXTURE_KEY = 'camp-wheel-hub';
export const CAMP_HUB_ASSET_PATH = '/regnemester/camp/wagon-wheel-hub-optimized.png';
